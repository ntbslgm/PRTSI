...
class AbstractTrainer(object):
   ...
   This class contain the main training functions for our AdAtime
    ...
    def train_model(self):
        ...
        #change
        self.last_model, self.best_model,self.all_labels, self.all_predictions = self.algorithm.update(self.trg_train_dl, self.loss_avg_meters, self.logger)

        return self.non_adapted_model, self.last_model, self.best_model, self.all_labels, self.all_predictions
